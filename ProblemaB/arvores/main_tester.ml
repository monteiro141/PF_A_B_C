...
let rec printingTree tree =
  match tree with
  | Leaf(a,b) -> Printf.printf "L(%d,%d)" (oneOrZero a) b
  | Node(a,b,c,d) -> Printf.printf "N: "; printingTree a; printingTree b; printingTree c; printingTree d
;;
